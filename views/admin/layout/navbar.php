        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <div class="navbar-nav me-auto mb-2 ms-5 gap-5 mb-lg-0 d-flex align-items-center" style="min-height: 70px">
                    <a href="<?php echo BASE_URL; ?>views/admin/home.php" class="nav-item nav-link navbar-section col-4 text-center" style="<?php if($_SESSION['location']==='home'){?>border-bottom: 2px solid #FFF <?php } ?>">Clientes</a>
                    <a href="<?php echo BASE_URL; ?>views/admin/products.php" class="nav-item nav-link navbar-section col-4 text-center" style="<?php if($_SESSION['location']==='products'){?>border-bottom: 2px solid #FFF <?php } ?>">Productos</a>
                    <a href="<?php echo BASE_URL; ?>views/admin/benefits.php" class="nav-item nav-link navbar-section col-4 text-center" style="<?php if($_SESSION['location']==='benefits'){?>border-bottom: 2px solid #FFF <?php } ?>">Beneficios</a>
                </div>
                <div class="d-flex flex-column flex-lg-row align-items-center gap-5">
                    <div class="d-flex align-items-center gap-2 user-info">
                        ...
                        <p class="mb-0 text-white"><?php if($_SESSION['role']==='administrator') {echo 'Administrador';} else { echo $actualUser['first_name'];} ?></p>
                    </div>
