            ...
            <?php if ($product['type'] === 'award'): ?>
                ...
                <div class="product-card">
                    ...
                    <?php if($product['stock']>=1): ?> <p> Disponible: <?php echo htmlspecialchars($product['stock']); ?> unidades </p><?php else:?><p style="color:#D61515; background:#d6151540" className='ps-2 rounded-1 col-7'>No disponible</p><?php endif; ?>
                        <button class='general-button' onclick="buyProduct('<?php echo $product['_id']; ?>')">Canjear</button>
                    </div>
                </div>
            <?php endif; ?>
        <?php endforeach; ?>
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <form id="buyProductForm">
                                    <p class="fs-3 text-black fw-bold">Canjear producto</p>
                                    <div>
                                        ...
                                        <p  class="form-control w-50 border-0 d-flex" disabled>Precio: ${data.product.price} puntos</p>
                            ...
                            preConfirm: () => {
                                ...
                                return fetch(`./services/redeemProduct.php?user_id=${userId}`, {
                                    method: 'POST',
                                    headers: {
